...
<form name="usual_score_form" id="usual_score_form" action="tchstu_mag.php" method="post" enctype='multipart/form-data'>
    ...
    <div class="col-md-12 text-center mb-3">
        ...
        <a class="btn btn-secondary" href="javascript:history.back()">
            <i class="fa fa-undo mr-2" aria-hidden="true"></i>取消
        </a>
        ...
        <!-- <a href="javascript:uscr_del(<{$uscore.dep_id}>,<{$uscore.course_id}>,<{$uscore.exam_stage}>,<{$uscore.exam_number}>)" class="btn   btn-danger"><i class="fa fa-trash-o mr-2" aria-hidden="true"></i>刪除
        </a> -->
    </div>
