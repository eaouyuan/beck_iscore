...
<form name="course_cp_form" id="course_cp_form" action="school_affairs.php" method="get">
    ...
    <div class="col">
        <div class="form-group row">
            ...
            <label for="sterm" class="col-form-label text-center validate[required]">來源學期：</label>
            <div class="col-1 text-left mr-3">
                <select class="custom-select" name="sterm" id="sterm">
                    <{$dropmenu.sterm}>
                </select>
            </div>
            ...
            <label for="dyear" class="col-form-label validate[required]">目的學年度：</label>
            <div class="col-1 text-left">
                <select class="custom-select" name="dyear" id="dyear">
                    <{$dropmenu.dyear}>
                </select>
            </div>
            <label for="dterm" class="col-form-label text-center validate[required]">目的學期：</label>
            <div class="col-1 text-left mr-3">
...
<{if $show_submit_btn=='0'}>
    <div class="alert alert-danger" role="alert">
        錯誤!！　目的學年度、學期，已有學生成績資料，故無法複製整學期課程！！
    </div>
<{/if}>
