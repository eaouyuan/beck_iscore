...
<form name="usual_score_list" id="usual_score_list" action="tchstu_mag.php" method="get">
            ...
            <tr class="table-info">
                ...
                <{foreach from=$score_count.$exam_stage.test_ary key=k item=exam_number}>
                        <th scope="col" class="text-center">第<{$exam_number}>次
                            ...
                            <a href="<{$xoops_url}>/modules/beck_iscore/tchstu_mag.php?op=usual_score_form&dep_id=<{$course.dep_id}>&course_id=<{$course.course_id}>&exam_stage=<{$exam_stage}>&exam_number=<{$exam_number}>" class="btn btn-warning btn-sm mr-2">
