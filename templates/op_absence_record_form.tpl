...
<form name="absence_record_form" id="absence_record_form" action="tchstu_mag.php" method="post" enctype='multipart/form-data'>
    ...
    <table class="table table-sm">
        <tbody>
            <{if $sn}>      
                <tr>
                    <th colspan="4"><h4> <{$sel.year}> 學年度 第 <{$AB_form.term}> 學期</h4></th>
                </tr>
            <{else}>
            <tr>
            ...
            <tr>    
                ...
                <th colspan="2">
                    ...
                    <div class="form-check form-check-inline m-1 col">
                        ...
                        <input type="text" class="form-control col" name="AB_other_text" id="AB_other_text" value="<{$AB_form.AB_other_text}> ">
                    </div>
                </th>
            </tr>
            <tr>    
                ...
                <th colspan="2">
                    <input type="text" class="form-control validate[required]" name="AB_date" id="AB_date" value="<{$AB_form.AB_date}>">
                </th>
            </tr>
            ...
            <tr>
                ...
                <td colspan="2">
                    <textarea class="form-control" id="AB_content" name="AB_content" rows="2"><{$AB_form.AB_content}></textarea>
                </td>
            </tr>
            <!-- 晨間缺席時間 -->
            <{if $AB_period_show.1}>
                <tr>
                    ...
                    <th class="p-2 text-left">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="earlym_stime" name="earlym_stime" value="<{$AB_form.earlym_stime}>">
                            <div class="input-group-prepend">
                                <span class="input-group-text">日期迄</span>
                            </div>
                            <input type="text" class="form-control" id="earlym_etime" name="earlym_etime" value="<{$AB_form.earlym_etime}>">
                        </div>
                    </th>
                    <th>
                        <div class="input-group">
                            ...
                            <div class="form-control" id="earlym_hour"><{$AB_form.earlym_hour}></div>
                            <div class="input-group-prepend">
                ...
                <tr>
                    ...
                    <th class="p-2 text-left">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="morning_stime" name="morning_stime" value="<{$AB_form.morning_stime}>">
                            <div class="input-group-prepend">
                                <span class="input-group-text">日期迄</span>
                            </div>
                            <input type="text" class="form-control" id="morning_etime" name="morning_etime" value="<{$AB_form.morning_etime}>">
                        </div>
                    </th>
                    <th colspan="2">
                        <div class="input-group">
                            ...
                            <div class="form-control" id="morning_hour"><{$AB_form.morning_hour}></div>
                            <div class="input-group-prepend">
                                <span class="input-group-text">小時</span>
                            </div>
                            <div class="input-group-append">
                ...
                <tr>
                    ...
                    <th class="p-2 text-left">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="night_stime" name="night_stime" value="<{$AB_form.night_stime}>">
                            <div class="input-group-prepend">
                                <span class="input-group-text">日期迄</span>
                            </div>
                            <input type="text" class="form-control" id="night_etime" name="night_etime" value="<{$AB_form.night_etime}>">
                        </div>
                    </th>
                    <th colspan="2">
                        <div class="input-group">
                            ...
                            <div class="form-control" id="night_hour"><{$AB_form.night_hour}></div>
                            <div class="input-group-prepend">
                                <span class="input-group-text">小時</span>
                            </div>
                            <div class="input-group-append">
    ...
    <div>
        <input name="earlym_hour" value="<{$AB_form.earlym_hour}>" type="hidden">
        <input name="morning_hour" value="<{$AB_form.morning_hour}>" type="hidden">
        <input name="night_hour" value="<{$AB_form.night_hour}>" type="hidden">

        <input name="uid" id="uid" value="<{$uid}>" type="hidden">
        <input name="op" id="op" value="<{$op}>" type="hidden">
        <!-- <input name="year" id="year" value="<{$AB_form.year}>" type="hidden">
        <input name="term" id="term" value="<{$AB_form.term}>" type="hidden"> -->
        <{if $sn}>
            <input name="sn" id="sn" value="<{$sn}>" type="hidden">
            <input name="AB_period" value="<{$AB_period}>" type="hidden">
        <{/if}>
        <{$XOOPS_TOKEN}>
    </div>
