...
CREATE TABLE `yy_exam_keyin_daterange` (
  ...
  `exam_value` enum('1','2','3','4','5','6') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '1=>第一次段考前平時考,2=>第一次段考,3=>第二次段考前平時考,4=>第二次段考,5=>第三次段考前平時考,6=>期末考',
...
CREATE TABLE `yy_term_total_score` (
  ...
  `comment` varchar(255) NULL DEFAULT '' COMMENT '備註',
  `grade` varchar(16) NULL DEFAULT '' COMMENT '年級',
  `reward_method` varchar(255) NULL DEFAULT '' COMMENT '獎勵方式',
  `sort` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '排序',
  `update_user` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '修改者',
  `update_date` datetime NOT NULL COMMENT '修改日期', 
...
CREATE TABLE `yy_absence_time` (
  ...
  `AB_kind` enum('A','B','C','D','E','G','99') NOT NULL COMMENT 'A公假 B事假 C病假 D喪假 E曠課 G晤談 99其他',
  `AB_other_text` varchar(255) NOT NULL COMMENT '其他請假類別',
  `AB_date` date NOT NULL COMMENT '缺席日期',
  `AB_content` text NOT NULL COMMENT '請假事由',
...
INSERT INTO `yy_exam_keyin_daterange` (`sn`, `exam_year`, `exam_term`, `exam_name`, `exam_value`, `start_date`, `end_date`, `status`, `sort`, `update_user`, `update_date`) VALUES
(1,	'109',	'2',	'第一次段考',	'2',	'2021-02-22',	'2021-06-30',	'1',	8,	8,	'2022-01-07 14:04:03'),
(2,	'109',	'2',	'第一次段考前平時考',	'1',	'2021-02-22',	'2021-06-30',	'1',	7,	8,	'2022-01-07 14:04:20'),
(3,	'109',	'2',	'第二次段考前平時考',	'3',	'2021-04-08',	'2021-06-30',	'1',	9,	8,	'2022-01-07 14:03:55'),
(4,	'109',	'2',	'第二次段考',	'4',	'2021-04-08',	'2021-06-30',	'1',	10,	8,	'2022-01-07 14:04:29'),
(5,	'109',	'2',	'第三次段考前平時考',	'5',	'2021-06-25',	'2021-06-30',	'1',	11,	1,	'2022-01-07 14:04:10'),
(13,	'109',	'2',	'期末考',	'6',	'2021-06-25',	'2021-07-01',	'1',	12,	10,	'2022-01-07 14:02:16'),
(7,	'110',	'1',	'第一次段考前平時考',	'1',	'2021-11-16',	'2021-11-16',	'1',	2,	8,	'2022-01-07 13:55:47'),
(8,	'110',	'1',	'第一次段考',	'2',	'2021-11-16',	'2021-11-16',	'1',	1,	8,	'2022-01-07 13:55:41'),
(9,	'110',	'1',	'第二次段考前平時考',	'3',	'2021-10-20',	'2021-12-06',	'1',	3,	8,	'2022-01-07 13:56:08'),
(10,	'110',	'1',	'第二次段考',	'4',	'2021-11-29',	'2021-12-06',	'1',	4,	8,	'2022-01-07 13:56:02'),
(11,	'110',	'1',	'第三次段考前平時考',	'5',	'2021-12-07',	'2022-01-21',	'1',	5,	8,	'2022-01-07 13:55:56'),
(12,	'110',	'1',	'期末考',	'6',	'2022-01-17',	'2022-01-21',	'1',	6,	8,	'2022-01-07 13:55:35');
